...
<h4 class="text-center">Pipeline has been built from Dev-->Test & Test 1-->Stage-->Prod environments</h4>
      <h4 class="text-center">Automation in trial 1 unsuccesful [Trial 2 in [inprogress]  [Continuous Deployment] now it is the test for fully manual [Continuous Delivery]</h4>
